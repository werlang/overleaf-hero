...
%
\title{Previsão de valores de ativos do mercado financeiro com Machine Learning}

\author{Oliveira}{Mauricio de Avila}

\advisor[Prof.~Dr.]{Werlang}{Pablo}
...
\keyword{Previsão de preços de ações}
\keyword{Keras}
