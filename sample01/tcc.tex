...
%
\title{BiteUp: uma aplicação para controle de Macronutrientes}

\author{Israel de Azevedo}{Davison}

\advisor[]{Santos Werlang}{Pablo}
\coadvisor[Marcelo]{Cairuga}{Lopes}

%defina aqui os nomes dos convidados das bancas, para compor a folha de avaliacao
\def\primeiroconvidadobanca{ Prof. Roberto Iraja Tavares da Costa Filho  }%
